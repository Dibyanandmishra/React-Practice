...
function App() {
  ...
  const [allowedNumber, setAllowedNumbers] = useState('false');
  ...
  const passwordGenerator = useCallback(()=>{
    ...
    setPassword(pass);
  }, [length, allowedNumber, allowedSpecialChar, setPassword])
  ...
  useEffect(() => {
    passwordGenerator()
  }, [length, allowedNumber, allowedSpecialChar, passwordGenerator])
    ...
    <div className='flex text-sm gap-x-2'>
      ...
      <div className="flex items-center gap-x-1">
          <input
              ...
              id="characterInput"
              onChange={() => {
                  SetAllowedSpecialChar((prev) => !prev )
              }}
          />
